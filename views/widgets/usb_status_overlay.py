...
class USBStatusOverlayWidget(QWidget):
    """
    ⚠ USB 전역 안내 위젯
    ...
    def _build_ui(self):
        ...
        self.label_desc = QLabel("USB Status")
    ...
    def show_connected(self):
        self._show("USB Power Connected")

    def show_disconnected(self):
        self._show("USB Power Disconnected")
    ...
    def show_warning(self):
        ...
        """
        if self._is_open:
            print("[USBStatusOverlay] already open → ignore")
            return

        print("[USBStatusOverlay] SHOW")
        self._is_open = True
    ...
    def on_ok_clicked(self):
        ...
        사용자가 경고를 확인하고 닫을 때
        """
        print("[USBStatusOverlay] OK clicked")
        self.hide_warning()