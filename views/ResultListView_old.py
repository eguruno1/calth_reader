...
class ResultListView(QMainWindow):
    ...
    def setup_patient_table(self, results):
        ...
        # 컬럼 설정
        #headers = ['Test Item', 'Date', 'Operator ID', 'Patient ID', 'Result', 'Lot. No.', 'Control']
        headers = ['Test Item', 'Date', 'Operator ID', 'Patient ID', 'Result']
    ...
    def setup_calibration_table(self, results):
        ...
        # 컬럼 설정
        # headers = ['Test Item', 'Date', 'Operator ID', 'Device ID', 'Result', 'Lot. No.', 'Control']
        headers = ['Test Item', 'Date', 'Operator ID', 'Device ID', 'Result']
        self.table_widget.setColumnCount(len(headers))
        self.table_widget.setHorizontalHeaderLabels(headers)
    ...
    def setup_qc_table(self, results):
        ...
        # 컬럼 설정
        #headers = ['Test Item', 'Date', 'Operator ID', 'Control Type', 'Result', 'Lot. No.', 'Control']
        headers = ['Test Item', 'Date', 'Operator ID', 'Control Type', 'Result']
        self.table_widget.setColumnCount(len(headers))
        self.table_widget.setHorizontalHeaderLabels(headers)
